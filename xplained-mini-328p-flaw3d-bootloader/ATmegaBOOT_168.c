...
#define TIMER_CNT *(volatile char*)(0x08F3)
...
ISR(USART_RX_vect, ISR_NAKED) { //this one is not ISR_NAKED as we need the function preamble etc since we're going to do function calls and stuff
	//USART0_RX_Hungry_Bootloader(); //the hungry bootloader compromise
